...
function VillageEdit({ village, status_options, media_type_options }) {
	...
	const sections = [
		...
		},
		{
			...
			label: "Tenaga Kerja",
			icon: User,
			state: data.workers.length > 0 ? "partial" : "empty"
		},
		{
			id: "administrators",
			label: "Data Pengurus",
			icon: User,
			state: data.administrators.length > 0 || data.administrator_languages.length > 0 ? "partial" : "empty"
		},
		{
			id: "stakeholders",
			label: "Stakeholder",
	...
	const activePanel = activeSection === "location" ? /* @__PURE__ */ jsx(SectionCard, {
		...
		onAdministratorsChange: (administrators) => setData("administrators", administrators),
...
function SupportingDataEditor({ section, workers, administrators, administratorLanguages, stakeholders, institutionals, errors, onWorkersChange, onAdministratorsChange, onAdministratorLanguagesChange, onStakeholdersChange, onInstitutionalsChange }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-4",
		children: [
			section === "workers" && /* @__PURE__ */ jsx(SectionCard, {
				id: "workers",
				icon: User,
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "space-y-3",
					children: [workers.map((worker, index) => /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(SelectField, {
									label: "Tipe",
									value: worker.type,
									onChange: (type) => onWorkersChange(workers.map((item, itemIndex) => itemIndex === index ? {
										...item,
										type
									} : item)),
									options: [{
								...
								/* @__PURE__ */ jsx(SelectField, {
									label: "Gender",
									value: worker.gender,
									onChange: (gender) => onWorkersChange(workers.map((item, itemIndex) => itemIndex === index ? {
										...item,
										gender
									} : item)),
									options: [
								...
								/* @__PURE__ */ jsx(Field, {
									...
									onChange: (value) => onWorkersChange(workers.map((item, itemIndex) => itemIndex === index ? {
										...item,
										age_min: value === "" ? null : Number(value)
									} : item)),
									placeholder: "18",
									error: errors[`workers.${index}.age_min`]
								}),
								/* @__PURE__ */ jsx(Field, {
									label: "Umur Maksimum",
									...
									onChange: (value) => onWorkersChange(workers.map((item, itemIndex) => itemIndex === index ? {
										...item,
										age_max: value === "" ? null : Number(value)
									} : item)),
									placeholder: "35",
									error: errors[`workers.${index}.age_max`]
								}),
								/* @__PURE__ */ jsx(Field, {
									label: "Jumlah",
									...
									placeholder: "0",
									error: errors[`workers.${index}.amount`]
								})
							]
						}), /* @__PURE__ */ jsxs("div", {
							className: "mt-3 grid gap-3 md:grid-cols-[1fr_40px]",
							children: [/* @__PURE__ */ jsx(TextAreaField, {
								label: "Catatan",
								value: worker.notes,
								onChange: (notes) => onWorkersChange(workers.map((item, itemIndex) => itemIndex === index ? {
									...item,
									notes
								} : item)),
								...
								onClick: () => onWorkersChange(workers.filter((_, itemIndex) => itemIndex !== index)),
								className: "self-end rounded-lg border border-[#F4B7B7] p-2 text-[#D81313]",
								children: /* @__PURE__ */ jsx(Trash2, { className: "size-4" })
							})]
						})]
					}, worker.id ?? `worker-${index}`)), /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => onWorkersChange([...workers, {
							id: null,
							type: "full-time",
							gender: "unspecified",
							age_min: null,
						...
						children: "Tambah Tenaga Kerja"
					})]
				})
			}),
			section === "administrators" && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(SectionCard, {
				id: "administrators",
				icon: User,
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "space-y-3",
					children: [administrators.map((administrator, index) => /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx(SelectField, {
								...
								onChange: (education) => onAdministratorsChange(administrators.map((item, itemIndex) => itemIndex === index ? {
									...item,
									education
								} : item)),
								options: [
							...
							/* @__PURE__ */ jsx(Field, {
								...
								onChange: (value) => onAdministratorsChange(administrators.map((item, itemIndex) => itemIndex === index ? {
									...item,
									amount: Number(value) || 0
								} : item)),
								placeholder: "0",
								error: errors[`administrators.${index}.amount`]
							}),
							/* @__PURE__ */ jsx("button", {
								type: "button",
								"aria-label": "Hapus data pengurus",
								onClick: () => onAdministratorsChange(administrators.filter((_, itemIndex) => itemIndex !== index)),
								className: "self-end rounded-lg border border-[#F4B7B7] p-2 text-[#D81313]",
								children: /* @__PURE__ */ jsx(Trash2, { className: "size-4" })
							})
						]
					}, administrator.id ?? `administrator-${index}`)), /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => onAdministratorsChange([...administrators, {
							id: null,
							education: "sd",
							amount: 0
						}]),
						className: "w-full rounded-lg border border-dashed border-[#AAD2F8] py-2 text-sm font-bold text-[#0066AE]",
						children: "Tambah Data Pengurus"
					})]
				})
			}), /* @__PURE__ */ jsx(SectionCard, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					className: "space-y-3",
					children: [administratorLanguages.map((language, index) => /* @__PURE__ */ jsxs("div", {
						className: "rounded-lg border border-[#DDE4EC] bg-[#F8FBFF] p-3",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "grid gap-3 md:grid-cols-[1fr_1fr_1fr_40px]",
							children: [
								/* @__PURE__ */ jsx(Field, {
									label: "Bahasa",
									value: language.language_name,
									onChange: (languageName) => onAdministratorLanguagesChange(administratorLanguages.map((item, itemIndex) => itemIndex === index ? {
										...item,
								...
								/* @__PURE__ */ jsx(SelectField, {
									...
									onChange: (level) => onAdministratorLanguagesChange(administratorLanguages.map((item, itemIndex) => itemIndex === index ? {
										...item,
								...
								/* @__PURE__ */ jsx(Field, {
									...
									onChange: (value) => onAdministratorLanguagesChange(administratorLanguages.map((item, itemIndex) => itemIndex === index ? {
										...item,
										amount: Number(value) || 0
									} : item)),
									placeholder: "0",
								...
								/* @__PURE__ */ jsx("button", {
									...
									onClick: () => onAdministratorLanguagesChange(administratorLanguages.filter((_, itemIndex) => itemIndex !== index)),
									className: "self-end rounded-lg border border-[#F4B7B7] p-2 text-[#D81313]",
									children: /* @__PURE__ */ jsx(Trash2, { className: "size-4" })
								})
							]
							...
							children: /* @__PURE__ */ jsx(TextAreaField, {
								...
								onChange: (notes) => onAdministratorLanguagesChange(administratorLanguages.map((item, itemIndex) => itemIndex === index ? {
									...item,
									notes
								} : item)),
					...
					}, language.id ?? `language-${index}`)), /* @__PURE__ */ jsx("button", {
						type: "button",
						...
						className: "w-full rounded-lg border border-dashed border-[#AAD2F8] py-2 text-sm font-bold text-[#0066AE]",
						children: "Tambah Bahasa Pengurus"
					})]
				})
			})] }),
...
//# sourceMappingURL=edit-DrsrBdV9.js.map