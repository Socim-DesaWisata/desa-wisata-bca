...
import { ArrowRight, BedDouble, ChevronDown, Clock3, Facebook, Image, Instagram, Mail, MapPin, Mountain, Phone, ScrollText, Search, ShieldCheck, ShoppingBag, Star, Store, TreePine, Users } from "lucide-react";
...
var aboutHighlights = [
	{
		icon: TreePine,
		title: "Potensi Alam",
		description: "Menampilkan karakter desa melalui lanskap, suasana, dan pengalaman lokal."
	},
	{
		icon: ScrollText,
		title: "Pengalaman Terkurasi",
		description: "Paket, atraksi, dan homestay ditampilkan dari data profil backend."
	},
	{
		icon: ShieldCheck,
		title: "Terhubung Pengelola",
		description: "Informasi kontak, alamat, dan titik kunjungan tersedia langsung dari data desa."
	}
];
var whyChooseUs = [
	{
...
function profileMediaUrl(item, fallbackIndex = 0) {
	return item.media.find((media) => media.is_cover)?.url || item.media[0]?.url || galleryFallbacks[fallbackIndex % galleryFallbacks.length];
}
...
function AboutHighlight({ icon: Icon, title, description }) {
	return /* @__PURE__ */ jsxs("div", {
		className: "rounded-[16px] border border-[#DCE3EA] bg-white p-4 shadow-[0_10px_24px_rgba(0,102,174,0.04)]",
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "mb-3 flex size-10 items-center justify-center rounded-full bg-[#EAF3FF] text-[#0066AE]",
			...
			/* @__PURE__ */ jsx("p", {
				className: "mt-1.5 text-[12px] leading-5 text-[#59564c]",
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					className: "mt-2 flex flex-wrap items-center gap-3 text-[11px] text-[#8a8577]",
					children: [item.opening_hours ? /* @__PURE__ */ jsxs("span", {
						className: "inline-flex items-center gap-1",
						children: [/* @__PURE__ */ jsx(Clock3, { className: "size-3.5" }), item.opening_hours]
					}) : null, item.price_text ? /* @__PURE__ */ jsx("span", { children: item.price_text }) : null]
				}),
				/* @__PURE__ */ jsx("p", {
					className: "mt-3 text-[12px] leading-6 text-[#59564c]",
					children: truncate(item.description)
				})
			]
		})]
	});
...
function VillageShow({ village }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Head, { title: `${village.name || "Desa Wisata"} - Desa Wisata BCA` }), /* @__PURE__ */ jsxs("main", {
		className: "min-h-screen bg-white px-4 py-5 text-[#26311f] md:px-6 lg:px-8",
		children: [
			/* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsxs("div", {
				className: "mx-auto overflow-hidden rounded-[28px] border border-[#DCE3EA] bg-white shadow-[0_16px_40px_rgba(0,102,174,0.06)]",
			...
			/* @__PURE__ */ jsx("section", {
				id: "tentang",
				className: "px-0 pt-14 pb-6",
				children: /* @__PURE__ */ jsxs("div", {
					className: "mx-auto grid max-w-[1180px] gap-8 lg:grid-cols-[0.95fr_1.05fr]",
					children: [/* @__PURE__ */ jsx("div", {
						className: "overflow-hidden rounded-[24px] border border-[#DCE3EA] bg-white shadow-[0_12px_30px_rgba(0,102,174,0.05)]",
						children: /* @__PURE__ */ jsx("img", {
							src: aboutImage,
							alt: `Tentang ${village.name}`,
							className: "h-full min-h-[300px] w-full object-cover"
						})
					}), /* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx(SectionHeading, { title: "Tentang Desa Wisata" }),
						/* @__PURE__ */ jsx("p", {
							className: "max-w-[520px] text-[14px] leading-7 text-[#59564c]",
							children: textOrFallback(village.description, "Belum ada deskripsi desa wisata yang tersedia.")
						}),
						/* @__PURE__ */ jsx("div", {
							className: "mt-6 grid gap-4 md:grid-cols-3",
							children: aboutHighlights.map((item) => /* @__PURE__ */ jsx(AboutHighlight, { ...item }, item.title))
						})
					] })]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionHeading, {
						...
						children: packages.length > 0 ? packages.map((item, index) => /* @__PURE__ */ jsx(ProfileCard, {
							item,
							index
						}, item.id)) : /* @__PURE__ */ jsx("div", {
							className: "rounded-[16px] border border-dashed border-[#BFD6EA] bg-[#F8FBFE] p-5 text-[13px] text-[#59564c]",
							children: "Belum ada data paket wisata dari backend."
						})
					})]
				})
			}),
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionHeading, {
						...
						children: attractions.length > 0 ? attractions.map((item, index) => /* @__PURE__ */ jsx(ProfileCard, {
							item,
							index: index + 1
						}, item.id)) : /* @__PURE__ */ jsx("div", {
							className: "rounded-[16px] border border-dashed border-[#BFD6EA] bg-[#F8FBFE] p-5 text-[13px] text-[#59564c]",
							children: "Belum ada data atraksi dari backend."
						})
					})]
				})
			}),
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(SectionHeading, {
						...
						className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",
						children: homestays.length > 0 ? homestays.map((item, index) => /* @__PURE__ */ jsx(ProfileCard, {
							item,
							index: index + 2
						}, item.id)) : /* @__PURE__ */ jsx("div", {
							className: "rounded-[16px] border border-dashed border-[#BFD6EA] bg-[#F8FBFE] p-5 text-[13px] text-[#59564c]",
							children: "Belum ada data homestay dari backend."
						})
					})]
				})
			}),
...
//# sourceMappingURL=show-1eb4NaB3.js.map