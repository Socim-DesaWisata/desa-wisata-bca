...
import { S as store, i as show } from "./survey-assignments-BfNUxixD.js";
import { Head, Link, useForm } from "@inertiajs/react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Banknote, BarChart3, GraduationCap, MapPin, Package, Plus, Save, Ticket, Trash2, UserRound, Users } from "lucide-react";
...
function CreatePariwisata({ assignment, category_options }) {
	...
	function submit(event) {
		...
		post(store.url(assignment.code), { preserveScroll: true });
	}
...
//# sourceMappingURL=create-pariwisata-C5Y7N4YD.js.map