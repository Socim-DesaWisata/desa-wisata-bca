...
import { Activity, ArrowRight, CheckCircle2, ChevronLeft, ChevronRight, ClipboardCheck, ClipboardList, ExternalLink, Eye, FileSearch, MoreHorizontal, Plus, Search, Trash2 } from "lucide-react";
...
function SurveyAssignmentIndex({ stats, assignments, filters, status_options, template_options, village_options, per_page_options }) {
	...
	function toggleAssignmentSelection(assignmentId, checked) {
		setSelectedAssignmentIds((current) => checked ? [...new Set([...current, assignmentId])] : current.filter((id) => id !== assignmentId));
	}
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
									...
									children: "Daftar Desa Wisata Tools Assessment Kemenpar"
								}), /* @__PURE__ */ jsx("p", {
...
//# sourceMappingURL=survey-assignment-V9IgUJU1.js.map