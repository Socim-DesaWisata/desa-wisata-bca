...
import { c as surveyAssignments, d as villages, l as umkm, t as dashboard } from "./routes-D0B6ewM7.js";
import { i as show } from "./survey-assignments-BfNUxixD.js";
...
import { ArrowDownToLine, ArrowRight, ArrowUpRight, Building2, CheckCircle2, ChevronDown, ChevronRight, ClipboardCheck, FileSearch, Info, LocateFixed, MapPin, MapPinned, MoreVertical, Plus, Store, Ticket, Timer, TrendingUp, X } from "lucide-react";
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: /* @__PURE__ */ jsxs("button", {
							className: "flex items-center gap-1 rounded-md border border-[#EFEFEF] px-2 py-1 text-xs font-semibold text-[#7C7C7C] outline-none hover:bg-gray-50 cursor-pointer",
							children: [
								generalReportFilter,
								" ",
						...
						children: [
							/* @__PURE__ */ jsx(DropdownMenuItem, {
								...
								onClick: () => setGeneralReportFilter("Hari Ini"),
								children: "Hari Ini"
							}),
							/* @__PURE__ */ jsx(DropdownMenuItem, {
								className: "cursor-pointer text-xs",
								onClick: () => setGeneralReportFilter("Bulan Ini"),
								children: "Bulan Ini"
							}),
							/* @__PURE__ */ jsx(DropdownMenuItem, {
								className: "cursor-pointer text-xs",
								onClick: () => setGeneralReportFilter("Tahun Ini"),
								children: "Tahun Ini"
							})
						]
					})] })]
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h2", {
							...
							children: [
								/* @__PURE__ */ jsx(DropdownMenuItem, {
									className: "cursor-pointer text-xs",
									onClick: () => setActivityFilter("7 Hari Terakhir"),
									children: "7 Hari Terakhir"
								}),
								/* @__PURE__ */ jsx(DropdownMenuItem, {
									className: "cursor-pointer text-xs",
									onClick: () => setActivityFilter("30 Hari Terakhir"),
									children: "30 Hari Terakhir"
								}),
								/* @__PURE__ */ jsx(DropdownMenuItem, {
									className: "cursor-pointer text-xs",
									onClick: () => setActivityFilter("Tahun Ini"),
									children: "Tahun Ini"
								})
							]
						})] })]
...
colors.success, colors.blue500, colors.warning, colors.danger;
villages.url(), surveyAssignments.url(), surveyAssignments.url({ query: { status: "submitted" } }), surveyAssignments.url();
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h2", {
					...
					className: "h-8 rounded-lg border border-[#EFEFEF] bg-white px-2 text-xs font-semibold text-[#7C7C7C] outline-none",
					children: [/* @__PURE__ */ jsx("option", { children: "Minggu Ini" }), /* @__PURE__ */ jsx("option", { children: "Bulan Ini" })]
				})]
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: data.length > 0 ? data.map((item, index) => /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("span", {
								className: "text-sm font-semibold text-[#303030] line-clamp-1 max-w-[120px]",
								children: item.label
							})
						]
					}), /* @__PURE__ */ jsx("span", {
...
function Dashboard({ dashboard_mode = "admin", kpis = [], village_map_points = [], top_village_surveys = [], top_umkm_surveys = [], top_pariwisata_surveys = [], top_umkm_categories = [], recent_assignments = [], activities = [] }) {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs(Panel, {
						className: "flex items-center overflow-hidden border-none bg-[#EAF2FE] p-0",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex-[1.5] p-5 pl-6 z-10",
							children: [
								/* @__PURE__ */ jsx("h3", {
								...
								/* @__PURE__ */ jsxs(Link, {
									href: surveyAssignments.url(),
									className: "inline-flex h-9 items-center justify-center gap-2 rounded-full bg-[#0039A6] pl-4 pr-1 text-xs font-bold text-white transition hover:bg-[#002B7F]",
						...
						className: "flex items-center overflow-hidden border-none bg-[#E8F5E9] p-0",
						children: [/* @__PURE__ */ jsxs("div", {
							className: "flex-[1.5] p-5 pl-6 z-10",
							children: [
								/* @__PURE__ */ jsx("h3", {
								...
								/* @__PURE__ */ jsxs(Link, {
									href: surveyAssignments.url(),
									className: "inline-flex h-9 items-center justify-center gap-2 rounded-full bg-[#4CAF50] pl-4 pr-1 text-xs font-bold text-white transition hover:bg-[#388E3C]",
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
								...
								children: [/* @__PURE__ */ jsx("h2", {
									...
									children: [
										/* @__PURE__ */ jsxs("button", {
											...
											className: "flex h-8 items-center gap-2 rounded-lg border border-[#EFEFEF] px-3 text-xs font-semibold text-[#303030] transition hover:bg-[#F7F7F7]",
											children: [
												/* @__PURE__ */ jsx(ArrowDownToLine, { className: "size-3.5" }),
												" ",
												"Export Excel"
											]
										}),
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: /* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsxs("span", {
															...
															className: "h-1.5 w-full overflow-hidden rounded-full bg-[#E6EEF5]",
															children: /* @__PURE__ */ jsx("span", {
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: /* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsxs("div", {
															...
															children: [/* @__PURE__ */ jsx("div", { className: "z-20 size-6 rounded-full border-2 border-white bg-gray-300" }), /* @__PURE__ */ jsx("div", { className: "z-10 size-6 rounded-full border-2 border-white bg-gray-400" })]
														}), row.enumerators > 2 && /* @__PURE__ */ jsxs("span", {
															className: "ml-1 text-[10px] font-bold text-[#7C7C7C]",
															children: ["+", row.enumerators - 2]
														})]
													})
												}),
												/* @__PURE__ */ jsx("td", {
												...
												/* @__PURE__ */ jsx("td", {
													...
													children: /* @__PURE__ */ jsxs("div", {
														...
														children: [/* @__PURE__ */ jsx(Link, {
															...
															children: /* @__PURE__ */ jsx(Info, { className: "size-4 text-[#7C7C7C]" })
														}), /* @__PURE__ */ jsx("button", {
															className: "inline-flex size-7 items-center justify-center rounded hover:bg-[#F1F5F8]",
															children: /* @__PURE__ */ jsx(MoreVertical, { className: "size-4 text-[#7C7C7C]" })
														})]
													})
												})
											]
						...
						/* @__PURE__ */ jsxs("div", {
							className: "flex items-start gap-3 rounded-xl border border-[#EAF3FF] bg-[#F8FBFE] p-4",
							children: [/* @__PURE__ */ jsx(Info, {
								...
								className: "mt-1.5 list-disc space-y-1 pl-4 text-xs font-medium text-[#0066AE]/80",
								children: [
									/* @__PURE__ */ jsx("li", { children: "Pastikan setiap assignment survey memiliki minimal 2 enumerator." }),
									/* @__PURE__ */ jsx("li", { children: "Update data desa dan UMKM secara berkala untuk menjaga akurasi laporan." }),
									/* @__PURE__ */ jsx("li", { children: "Perhatikan status survey yang belum dimulai agar program berjalan tepat waktu." })
								]
							})] })]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(TopStatisticList, {
									...
									icon: Store,
									data: top_umkm_surveys.slice(0, 3).map((s) => ({
										label: s.name,
										value: `Rp${(s.score * 125e4).toLocaleString("id-ID")}`
									})),
									linkHref: umkm.url(),
								...
								/* @__PURE__ */ jsx(TopStatisticList, {
									...
									icon: MapPin,
									data: top_pariwisata_surveys.slice(0, 3).map((s) => ({
										label: s.name,
										value: `Rp${(s.score * 185e4).toLocaleString("id-ID")}`
									})),
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("h2", {
										...
										className: "flex items-center gap-1 text-xs font-bold text-[#0066AE]",
										children: [/* @__PURE__ */ jsx(Plus, { className: "size-3" }), " Tambah Jadwal"]
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
									className: "mb-4",
									children: [
										/* @__PURE__ */ jsxs("div", {
											className: "mb-2 flex items-center justify-between px-2 text-sm font-bold text-[#303030]",
											children: [
												/* @__PURE__ */ jsx(ChevronRight, { className: "size-4 rotate-180 cursor-pointer" }),
												"Mei 2025",
												/* @__PURE__ */ jsx(ChevronRight, { className: "size-4 cursor-pointer" })
											]
										}),
										/* @__PURE__ */ jsxs("div", {
											className: "mb-2 grid grid-cols-7 gap-1 text-center text-xs font-semibold text-[#7C7C7C]",
											children: [
										...
										/* @__PURE__ */ jsxs("div", {
											className: "grid grid-cols-7 gap-1 text-center text-xs font-medium text-[#303030]",
											children: [
												/* @__PURE__ */ jsx("div", {
													className: "text-[#DDE4EC]",
													children: "27"
												}),
												/* @__PURE__ */ jsx("div", {
													className: "text-[#DDE4EC]",
												...
												/* @__PURE__ */ jsx("div", { children: "14" }),
												/* @__PURE__ */ jsx("div", { children: "15" }),
												/* @__PURE__ */ jsx("div", { children: "16" }),
												/* @__PURE__ */ jsx("div", { children: "17" }),
												/* @__PURE__ */ jsx("div", { children: "18" }),
												/* @__PURE__ */ jsx("div", { children: "19" }),
												/* @__PURE__ */ jsx("div", { children: "20" }),
												/* @__PURE__ */ jsx("div", { children: "21" }),
												/* @__PURE__ */ jsx("div", { children: "22" }),
												/* @__PURE__ */ jsx("div", {
													className: "rounded bg-[#0066AE] font-bold text-white",
													children: "23"
												}),
												/* @__PURE__ */ jsx("div", { children: "24" }),
												/* @__PURE__ */ jsx("div", { children: "25" }),
												/* @__PURE__ */ jsx("div", { children: "26" }),
												/* @__PURE__ */ jsx("div", { children: "27" }),
												/* @__PURE__ */ jsx("div", { children: "28" }),
												/* @__PURE__ */ jsx("div", { children: "29" }),
												/* @__PURE__ */ jsx("div", { children: "30" }),
												/* @__PURE__ */ jsx("div", { children: "31" })
											]
										})
									]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											className: "flex items-center justify-between text-xs font-semibold text-[#303030]",
											children: [/* @__PURE__ */ jsxs("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-[#00893D]" }), "Training Enumerator Batch 3"]
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-[#0066AE]" }), "Visitasi Desa Mulyosari"]
											}), /* @__PURE__ */ jsx("span", { children: "11:00" })]
										}),
										/* @__PURE__ */ jsxs("div", {
											className: "flex items-center justify-between text-xs font-semibold text-[#303030]",
											children: [/* @__PURE__ */ jsxs("div", {
												className: "flex items-center gap-2",
												children: [/* @__PURE__ */ jsx("span", { className: "size-2 rounded-full bg-[#FF944C]" }), "Review Laporan CSR Q2"]
											}), /* @__PURE__ */ jsx("span", { children: "14:00" })]
										})
									]
								})
							]
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsx("div", { className: "absolute top-8 bottom-[-16px] left-[15px] w-[2px] bg-[#EFEFEF]" }),
											/* @__PURE__ */ jsx("img", {
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
														...
														className: "mt-0.5 leading-4 text-[#7C7C7C]",
														children: [
														...
														className: "flex size-5 items-center justify-center rounded-full bg-[#00893D] text-white",
														children: /* @__PURE__ */ jsx(CheckCircle2, { className: "size-3" })
													})]
												}), /* @__PURE__ */ jsx("p", {
													className: "mt-1 text-[10px] text-[#A0A0A0]",
													children: "23 Mei 2025, 16:10"
												})]
											})
										]
									}),
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
														...
														className: "flex size-5 items-center justify-center rounded-full bg-[#2FA6FC] text-white",
														children: /* @__PURE__ */ jsx("span", { className: "size-2 rounded-full border border-current" })
													})]
												}), /* @__PURE__ */ jsx("p", {
													className: "mt-1 text-[10px] text-[#A0A0A0]",
													children: "23 Mei 2025, 14:35"
												})]
											})
										]
									}),
										...
										children: [/* @__PURE__ */ jsx("img", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
													...
													className: "flex size-5 items-center justify-center rounded-full bg-[#0066AE] text-white",
													children: /* @__PURE__ */ jsx(ArrowUpRight, { className: "size-3" })
												})]
											}), /* @__PURE__ */ jsx("p", {
												className: "mt-1 text-[10px] text-[#A0A0A0]",
												children: "22 Mei 2025, 17:45"
											})]
										})]
									})
								]
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-3",
											children: [/* @__PURE__ */ jsx("span", {
												className: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#F1F5F8] text-[#0066AE]",
												children: /* @__PURE__ */ jsx(Store, { className: "size-4" })
											}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#303030]",
												children: "Pelatihan Digital UMKM"
											}), /* @__PURE__ */ jsx("p", {
												className: "text-[11px] text-[#7C7C7C]",
												children: "Desa Mulyosari"
											})] })]
										}), /* @__PURE__ */ jsxs("div", {
											className: "text-right",
											children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#00893D]",
												children: "+ Rp30.000.000"
											}), /* @__PURE__ */ jsx("span", {
												className: "mt-0.5 inline-block rounded bg-[#EAF8F0] px-1.5 py-0.5 text-[9px] font-bold text-[#00893D]",
												children: "Berjalan"
											})]
										})]
									}),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("span", {
												...
												className: "text-xs font-bold text-[#303030]",
												children: "Pengembangan Homestay"
											}), /* @__PURE__ */ jsx("p", {
												className: "text-[11px] text-[#7C7C7C]",
												children: "Keputih Desa Asri"
											})] })]
										}), /* @__PURE__ */ jsxs("div", {
											className: "text-right",
											children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#00893D]",
												children: "+ Rp40.000.000"
											}), /* @__PURE__ */ jsx("span", {
												className: "mt-0.5 inline-block rounded bg-[#EAF8F0] px-1.5 py-0.5 text-[9px] font-bold text-[#00893D]",
												children: "Berjalan"
											})]
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("span", {
												className: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#F1F5F8] text-[#0066AE]",
												children: /* @__PURE__ */ jsx(Ticket, { className: "size-4" })
											}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#303030]",
												children: "Festival Kuliner Nusantara"
											}), /* @__PURE__ */ jsx("p", {
												className: "text-[11px] text-[#7C7C7C]",
												children: "Desa Lontar"
											})] })]
										}), /* @__PURE__ */ jsxs("div", {
											className: "text-right",
											children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#0066AE]",
												children: "- Rp15.000.000"
											}), /* @__PURE__ */ jsx("span", {
												className: "mt-0.5 inline-block rounded bg-[#EAF3FF] px-1.5 py-0.5 text-[9px] font-bold text-[#0066AE]",
												children: "Selesai"
											})]
										})]
									}),
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-3",
											children: [/* @__PURE__ */ jsx("span", {
												className: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#F1F5F8] text-[#00893D]",
												children: /* @__PURE__ */ jsx(Store, { className: "size-4" })
											}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#303030]",
												children: "Pengelolaan Sampah Desa"
											}), /* @__PURE__ */ jsx("p", {
												className: "text-[11px] text-[#7C7C7C]",
												children: "Desa Pakal"
											})] })]
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											className: "flex items-center gap-3",
											children: [/* @__PURE__ */ jsx("span", {
												className: "flex size-8 shrink-0 items-center justify-center rounded-lg bg-[#FDECEC] text-[#D81313]",
												children: /* @__PURE__ */ jsx(Store, { className: "size-4" })
											}), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
												className: "text-xs font-bold text-[#303030]",
												children: "Promosi Desa Wisata"
											}), /* @__PURE__ */ jsx("p", {
												className: "text-[11px] text-[#7C7C7C]",
												children: "Lidah Wetan"
											})] })]
										}), /* @__PURE__ */ jsxs("div", {
											className: "text-right",
											children: [/* @__PURE__ */ jsx("p", {
												...
												className: "mt-0.5 inline-block rounded bg-[#FDECEC] px-1.5 py-0.5 text-[9px] font-bold text-[#D81313]",
												children: "Dibatalkan"
											})]
										})]
									})
...
//# sourceMappingURL=dashboard-XOcIENAe.js.map