...
import { a as pariwisata, c as surveyAssignments, d as villages, i as logout, l as umkm, n as home, o as questions, t as dashboard, u as users } from "./assets/routes-D0B6ewM7.js";
...
import { BarChart3, ChartColumnBig, ChevronDown, ClipboardCheck, ClipboardList, LayoutDashboard, LogOut, MapPinned, Menu, Settings, Store, UserCog, Users, XIcon } from "lucide-react";
...
function AppShell({ children, variant = "sidebar" }) {
	...
	return /* @__PURE__ */ jsx("div", {
		className: "min-h-[100dvh] overflow-x-hidden bg-[#f7f8fb] font-sans text-[#111827]",
		children
	});
}
//#endregion
...
var SIDEBAR_LOGO_SRC = "/logo/logo-bca-white.svg";
...
function AdminSidebarContent({ onNavigate }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.08)_0%,transparent_28%,rgba(255,255,255,0.04)_100%)]" }),
			/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(Link, {
					...
					"aria-label": "BCA",
					children: /* @__PURE__ */ jsx(SidebarLogo, { className: "h-auto max-h-none w-[100px]" })
				}), /* @__PURE__ */ jsx("div", { className: "h-px bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.24),transparent)]" })]
			}),
			/* @__PURE__ */ jsx("nav", {
				className: "relative flex-1 [scrollbar-width:none] overflow-y-auto py-2 [&::-webkit-scrollbar]:hidden",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					className: "mb-2 px-2 text-[10px] font-semibold tracking-[0.08em] text-white/45 uppercase",
					children: "CSR Dashboard"
				}), auth.user && /* @__PURE__ */ jsxs(DropdownMenu, { children: [/* @__PURE__ */ jsx(DropdownMenuTrigger, {
					asChild: true,
					children: /* @__PURE__ */ jsxs("button", {
						className: "flex w-full items-center gap-2.5 rounded-2xl border border-white/16 bg-white/12 p-2.5 text-left shadow-[inset_0_1px_0_rgba(255,255,255,0.14)] backdrop-blur transition duration-150 hover:bg-white/16",
						children: [
							/* @__PURE__ */ jsxs("span", {
...
function AppSidebarHeader({ breadcrumbs = [] }) {
	...
	return /* @__PURE__ */ jsx("header", {
		className: "sticky top-0 z-10 flex h-14 items-center justify-between gap-3 border-b border-[#d9dee7] bg-white px-3 sm:px-4 lg:h-[60px] lg:px-5 xl:px-6",
...
function AuthSimpleLayout({ children, title, description }) {
	return /* @__PURE__ */ jsx("div", {
		className: "flex min-h-svh flex-col items-center justify-center bg-[#F7F7F7] px-4 py-8 font-bca text-[#303030] sm:px-6",
		children: /* @__PURE__ */ jsx("div", {
			className: "w-full max-w-[420px] rounded-3xl border border-[#E4EAF0] bg-white px-6 py-7 shadow-[0_18px_46px_rgba(9,57,103,0.10)] sm:px-8",
...
var render = await createInertiaApp({
	resolve: async (name, page) => {
		const pages = /* @__PURE__ */ Object.assign({
			...
			"./pages/auth/forgot-password.tsx": () => import("./assets/forgot-password-nZSKaQPc.js"),
			"./pages/auth/login.tsx": () => import("./assets/login-Bly0onA_.js"),
			"./pages/auth/register.tsx": () => import("./assets/register-BDTsJbmj.js"),
			...
			"./pages/auth/verify-email.tsx": () => import("./assets/verify-email-B8VVWxKE.js"),
			"./pages/chatbot/index.tsx": () => import("./assets/chatbot-BUbe8aFt.js"),
			"./pages/dashboard.tsx": () => import("./assets/dashboard-XOcIENAe.js"),
			"./pages/pariwisata/index.tsx": () => import("./assets/pariwisata-DXAKMSp_.js"),
			"./pages/questions/index.tsx": () => import("./assets/questions-D1-Sv79b.js"),
			"./pages/questions/templates.tsx": () => import("./assets/templates-BHfeQmOY.js"),
			...
			"./pages/survey/take-survey.tsx": () => import("./assets/take-survey-D9PLU8Gy.js"),
			"./pages/survey-assignment/create-pariwisata.tsx": () => import("./assets/create-pariwisata-C5Y7N4YD.js"),
			"./pages/survey-assignment/create-umkm.tsx": () => import("./assets/create-umkm-CrmcJUcx.js"),
			"./pages/survey-assignment/index.tsx": () => import("./assets/survey-assignment-DB-OCWgV.js"),
			"./pages/survey-assignment/show-pariwisata.tsx": () => import("./assets/show-pariwisata-DSQ8qk0e.js"),
			"./pages/survey-assignment/show-umkm.tsx": () => import("./assets/show-umkm-D6UDFvgV.js"),
			"./pages/survey-assignment/show.tsx": () => import("./assets/show-YgsnY5vJ.js"),
			"./pages/survey-assignment/take-survey-pariwisata.tsx": () => import("./assets/take-survey-pariwisata-B730po_6.js"),
			"./pages/umkm/index.tsx": () => import("./assets/umkm-D1BiaZsF.js"),
			"./pages/users/index.tsx": () => import("./assets/users-C2OOOLFI.js"),
			"./pages/villages/edit.tsx": () => import("./assets/edit-CeLriE_t.js"),
			"./pages/villages/index.tsx": () => import("./assets/villages-Cade-EJg.js"),
			"./pages/villages/show.tsx": () => import("./assets/show-1eb4NaB3.js"),
			"./pages/welcome.tsx": () => import("./assets/welcome-ouhu1Xhx.js")
		});
