...
class UpdateTourismVillageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'workers.*.type' => ['required', 'string', Rule::in(['full-time', 'part-time'])],
            'workers.*.gender' => ['required', 'string', Rule::in(['male', 'female', 'unspecified'])],
            'workers.*.age_min' => ['nullable', 'integer', 'between:0,120'],
            'workers.*.age_max' => ['nullable', 'integer', 'between:0,120', 'gte:workers.*.age_min'],
            'workers.*.amount' => ['required', 'integer', 'min:0'],
            'workers.*.notes' => ['nullable', 'string'],
            'administrators' => ['nullable', 'array'],
            'administrators.*.id' => ['nullable', 'integer'],
            'administrators.*.education' => ['required', 'string', Rule::in(['sd', 'smp', 'sma', 'd3', 's1/d4', 's2', 's3'])],
            'administrators.*.amount' => ['required', 'integer', 'min:0'],
