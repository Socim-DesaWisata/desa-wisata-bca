...
const VillageSurveyAssignmentController = { index, store, destroy, restore, createUmkm, storeUmkm, createPariwisata, storePariwisata, takePariwisataSurvey, storePariwisataSurveyDraft, destroyPariwisataSurveyDocument, downloadPariwisataSurveyExport, showPariwisata, exportPariwisata, updatePariwisata, exportUmkm, showUmkm, updateUmkm, updateUmkmSurveyAnswer, storeUmkmDocument, updateUmkmDocument, destroyUmkmDocument, exportMethod, updateVillageAnnualData, show, update, takeSurvey, storeSurveyDraft, destroySurveyDocument, export: exportMethod }
